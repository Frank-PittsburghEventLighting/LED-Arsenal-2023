...
//
//   Fix  # 87   Need a good chase for Halloween  Done
//   
...
extern CRGBPalette16 FourTwentyPalette;                 //  Unknown Error when used in Key Code ???  Key #82
...
FastLED.show();
    ...
    displayPatternChase(convKeyP,  "Knight Rider");
  }
...
//      delay(5);         //   Start delay= 300  Maybe not needed
        ...
        displayPatternChase(convKeyP,  "Evil EYE");
  }                      
   //    ************************   End Key 75    *******************************
...
FastLED.show();   }
    ...
    displayPatternChase(convKeyP,  "Tripin' Kitt");
  }
...
//                                     CRGB::Yellow, CRGB::White, CRGB::Yellow, CRGB::Yellow, CRGB::DarkOrange, CRGB::Red };  //  Key_77
 ...
 EVERY_N_MILLISECONDS(20) {       // Start=20
  ...
  EVERY_N_MILLISECONDS(40) {
   ...
   FastLED.show();
    displayPatternChase(convKeyP,  "Soft Color Change");
  }
...
void meteorShower(){
  ...
  if(RAINBOWs == true){ hue36 = hue36 - 20; if(hue36 <= 0){  hue36 = 1; } }
  ...
  case 0:
    ...
    break;
  case 1:
    leds[0] = CHSV((hue36 - 20), 255, 210);
    break;
  case 2:
    leds[0] = CHSV((hue36 - 22), 255, 180);
    break;
  case 3:
    leds[0] = CHSV((hue36 - 23), 255, 150);
    break;
  case 4:
    leds[0] = CHSV((hue36 - 24), 255, 110);
    break;
  case 5:
    leds[0] = CHSV((hue36 - 25), 255, 90);
    break;
  case 6:
    leds[0] = CHSV((hue36 - 26), 160, 60);
    break;
  case 7:
    leds[0] = CHSV((hue36 - 27), 140, 40);
    break;
  case 8:
    leds[0] = CHSV((hue36 - 28), 120, 20);
    break;
  case 9:
    leds[0] = CHSV((hue36 - 29), 100, 20);
    break;
  case 10:
    leds[0] = CRGB::Black;
    break;
